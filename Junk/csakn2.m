...
dir_n ="csakn2" %strrep(strrep(datestr(datetime), ' ', '_'),':','.');
mkdir(dir_n);
...
fprintf(fileID,'Kristály hõmérséklete: %3.0f\n',T);
...
v6_fgv =@(z,A_kompozit) diffegy_conv_csakn2(z,A_kompozit,omega,T,k_omega,k_OMEGA,k_omegaSH,khi_eff,dnu,domega,k_omega0,omega0,gamma,cry,simp);
