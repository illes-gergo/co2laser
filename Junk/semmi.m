...
dir_n = "semmi"; %strrep(strrep(datestr(datetime), ' ', '_'),':','.');
mkdir(dir_n);
...
v6_fgv =@(z,A_kompozit) diffegy_conv_semmi(z,A_kompozit,omega,T,k_omega,k_OMEGA,k_omegaSH,khi_eff,dnu,domega,k_omega0,omega0,gamma,cry,simp);
